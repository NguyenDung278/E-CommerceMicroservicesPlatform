...
export function ProductCard({
    ...
    return (
      <article className="product-card-archive">
        ...
        <div className="product-card-archive-copy">
          ...
          <p className="product-card-archive-subtitle">
            {product.brand || product.category || "ND Atelier"}
          </p>
          ...
          {onBuyNow ? (
            <div className="product-card-archive-links">
              ...
              <button
                className="catalog-archive-buy-link"
                type="button"
  ...
  return (
    <article
      className={
        isAdminCard
          ? "product-card product-card-admin-shell"
    ...
    >
      <div className="product-card-media-shell">
        ...
        <div className="product-card-badge-row">
          ...
          {accentTag ? (
            <span className="product-card-badge product-card-badge-muted">#{accentTag}</span>
          ) : null}
        </div>
      </div>
