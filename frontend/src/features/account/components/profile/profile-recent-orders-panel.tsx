...
import { formatShortDate, formatShortOrderId } from "../../utils/account-presentation";
import { getProfileOrderStatusClassName } from "../../utils/profile-editor";
          ...
          <tbody>
            {orders.map((order) => (
              <tr key={order.id}>
                ...
                <td>
                  <span className={getProfileOrderStatusClassName(order.status)}>
