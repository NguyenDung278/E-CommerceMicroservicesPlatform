...
import "@/styles/pages/account/orders-page.css";
    ...
    <AccountPageLayout>
      <div className="orders-route">
        <header className="orders-route-head">
          <h1>Order History</h1>
          <p>
            Review your past purchases and track current deliveries from our latest seasonal
            collections.
          </p>
        </header>
        ...
        {isLoading ? (
          ...
          <>
                ...
                <article className="orders-route-card" key={order.id}>
                  <div className="orders-route-thumb" aria-hidden="true">
                    <span className="orders-route-thumb-kicker">
                      {order.items.length}{" "}
                      {order.items.length === 1 ? "piece selected" : "pieces selected"}
                    </span>
                  ...
                  <div className="orders-route-card-body">
                    <div className="orders-route-card-head">
                      ...
                      <strong
                        className={`orders-route-status orders-route-status-${getOrderStatusTone(order.status)}`}
                      >
            ...
            <div className="orders-route-footer">
              {hasMoreOrders ? (
                <button
                  className="orders-route-load-more"
                  type="button"
