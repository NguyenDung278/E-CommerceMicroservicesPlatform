...
export function NotificationsPage() {
  ...
  const preferenceCards: Array<{
    ...
    },
    {
      ...
      description:
        "Get instant shipping updates and important account alerts on your mobile device.",
    },
    {
      key: "orderUpdates",
      icon: "OU",
    ...
    },
    {
      ...
      description:
        "Receive recovery notices, login warnings and verification reminders when needed.",
    },
  ];
  ...
  const feedItems = useMemo<NotificationFeedItem[]>(() => {
    ...
    items.push({
      ...
      description:
        "Discover fresh pieces and editorial releases curated for your ND Shop account area.",
      meta: "Editorial",
    });
    ...
    <AccountPageLayout>
      <div className="notifications-route">
        <header className="notifications-route-head">
          <h1>Notifications</h1>
          <p>
            Stay updated with your orders, payment activity and account security in one clean feed.
          </p>
        </header>
            ...
            <article className="notifications-route-pref" key={item.key}>
              <div className="notifications-route-pref-head">
                ...
                <button
                  ...
                  type="button"
                  onClick={() =>
                    setPrefs((current) => ({ ...current, [item.key]: !current[item.key] }))
                  }
                >
                  <span />
                </button>
