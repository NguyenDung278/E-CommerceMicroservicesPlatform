      ...
      <section className="auth-status-shell">
        <aside className="auth-status-story">
          ...
          <div className="auth-status-copy">
            ...
            <p>
              Màn này bám trực tiếp contract backend hiện có: token được đọc từ query string, gửi
              sang gateway, rồi cập nhật profile cục bộ nếu phiên người dùng đang tồn tại.
            </p>
          </div>
          ...
          <div className="auth-status-story-list">
            <article>
              ...
              <span>
                Không thêm OTP hay route phụ. Flow giữ nguyên theo backend contract hiện tại.
              </span>
            </article>
            <article>
              <strong>Profile refresh an toàn</strong>
              <span>
                Frontend chỉ refresh profile sau khi verify thành công và đang có phiên đăng nhập.
              </span>
            </article>
            <article>
              <strong>Recovery rõ ràng</strong>
              <span>
                Người dùng luôn có đường quay lại account, login hoặc trang chủ sau khi xử lý.
              </span>
            </article>
          </div>
        </aside>
        ...
        <article className="auth-status-panel">
          <div className="auth-status-panel-inner">
            ...
            <div
              className={status === "error" ? "feedback feedback-error" : "feedback feedback-info"}
            >
              {message}
            </div>
