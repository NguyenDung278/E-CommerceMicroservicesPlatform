      ...
      <section className="auth-status-shell">
        <aside className="auth-status-story">
          ...
          <div className="auth-status-copy">
            ...
            <p>
              Reset password tiếp tục dùng token từ query string, không tạo thêm bước OTP. Frontend
              chỉ lo validate dữ liệu mới và phản hồi lại kết quả từ API.
            </p>
          </div>
          ...
          <div className="auth-status-story-list">
            ...
            <article>
              ...
              <span>
                Nếu thiếu hoặc hết hạn token, người dùng nhận được đường quay lại luồng recovery
                ngay.
              </span>
            </article>
            <article>
              ...
              <span>
                Visual language được giữ đồng bộ với login và register, không còn tách rời khỏi
                storefront.
              </span>
            </article>
          </div>
              ...
              <div className="auth-password-grid" aria-live="polite">
                {passwordChecks.map((item) => (
                  <div
                    className={
                      item.passed
                        ? "auth-password-item auth-password-item-checked"
                        : "auth-password-item"
                    }
                    key={item.label}
                  >
