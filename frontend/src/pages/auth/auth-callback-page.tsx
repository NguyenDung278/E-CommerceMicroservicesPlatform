        ...
        <aside className="auth-status-story">
          ...
          <div className="auth-status-copy">
            ...
            <p>
              ...
              rồi điều hướng bạn trở về luồng mua sắm trước đó.
            </p>
          </div>
          ...
          <div className="auth-status-story-list">
            <article>
              ...
              <span>
                Token truy cập thật chỉ được trả về qua API exchange sau khi frontend đã quay lại
                origin an toàn.
              </span>
            </article>
            <article>
              ...
              <span>
                Google, Facebook và email/password đều đi qua cùng một cơ chế lưu token và bootstrap
                profile.
              </span>
            </article>
            <article>
