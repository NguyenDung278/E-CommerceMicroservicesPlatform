...
4. **Review tổng thể trước**: Đọc [learning/11-senior-source-code-review-guide.md](./learning/11-senior-source-code-review-guide.md) để có góc nhìn senior/mentor về toàn repo, điểm mạnh, điểm yếu và tư duy thiết kế.
5. **Đọc hiểu Code**: Chuyển sang [annotated/README.md](./annotated/README.md) để bắt đầu đọc code có hướng dẫn chi tiết. Đừng lướt qua [annotated/shared-packages.md](./annotated/shared-packages.md).
6. **Thực hành Code**: Hãy thử sức với [learning/09-how-to-add-new-feature.md](./learning/09-how-to-add-new-feature.md) để tự tay viết 1 API xuyên suốt hệ thống.
7. **Gỡ lỗi**: Đọc [learning/10-guide-to-debugging.md](./learning/10-guide-to-debugging.md) để biết cách xem log và trace lỗi 500.
...
- [11-senior-source-code-review-guide.md](./learning/11-senior-source-code-review-guide.md): **[MỚI]** Review toàn repo theo góc nhìn Senior Engineer + Technical Mentor.
...
## 📌 Tài liệu nên đọc nếu muốn hiểu repo ở mức Senior

Nếu bạn muốn dùng repo này như một bộ tài liệu học lâu dài thay vì chỉ đọc từng file rời rạc, hãy đọc bộ sau theo thứ tự:
...
3. [annotated/shared-packages.md](./annotated/shared-packages.md)
4. [annotated/product-service.md](./annotated/product-service.md)
5. [annotated/order-service.md](./annotated/order-service.md)

---

_Chúc bạn có hành trình khám phá source code và học tập thú vị cùng dự án E-Commerce này!_
