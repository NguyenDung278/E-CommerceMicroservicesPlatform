...
### 21. Next.js Client — 🟡 In Progress

**Service:** `client/`
**Stack:** Next.js 16.2.1, React 19, TypeScript

**Đã làm:**

- [x] Thiết lập Next.js với App Router
- [x] Cấu trúc thư mục `src/`
...
- [ ] UI components theo thiết kế MCP/Stitch
- [ ] Routing và layouts đầy đủ
