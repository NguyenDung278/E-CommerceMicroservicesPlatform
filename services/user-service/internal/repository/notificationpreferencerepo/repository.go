package notificationpreferencerepo
...
func (r *Repository) ListByUserID(ctx context.Context, userID string) ([]*model.NotificationPreference, error) {
...
func (r *Repository) UpsertMany(ctx context.Context, userID string, preferences []*model.NotificationPreference) error {
