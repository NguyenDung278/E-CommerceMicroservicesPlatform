...
func NewPhoneVerification(db *sql.DB) *PhoneVerificationRepository {
	return NewPhoneVerificationWithExecutor(db)
}

func NewPhoneVerificationWithExecutor(executor common.SQLExecutor) *PhoneVerificationRepository {
	return &PhoneVerificationRepository{executor: executor}
}

func (r *PhoneVerificationRepository) Create(ctx context.Context, challenge *model.PhoneVerificationChallenge) error {
	query := `
...
func (r *PhoneVerificationRepository) GetByID(ctx context.Context, id string) (*model.PhoneVerificationChallenge, error) {
	query := `
...
func (r *PhoneVerificationRepository) GetLatestActiveByUserID(ctx context.Context, userID, purpose string) (*model.PhoneVerificationChallenge, error) {
	query := `
		SELECT id, user_id, purpose, phone_candidate, otp_hash, expires_at,
		       resend_available_at, last_sent_at, attempt_count, max_attempts,
		       status, telegram_chat_id, verified_at, consumed_at, created_at, updated_at
...
func (r *PhoneVerificationRepository) Update(ctx context.Context, challenge *model.PhoneVerificationChallenge) error {
	query := `
...
func (r *PhoneVerificationRepository) DeleteExpired(ctx context.Context) error {
