...
func (h *UserHandler) RegisterRoutes(e *echo.Echo, jwtSecret string) {
	...
	users.GET("/profile/phone-verification", h.forwardRequest)
	users.POST("/profile/phone-verification/send-otp", h.forwardRequest)
	users.POST("/profile/phone-verification/verify-otp", h.forwardRequest)
	users.POST("/profile/phone-verification/resend-otp", h.forwardRequest)
